    ...
    fun securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests {
                ...
                it.requestMatchers(HttpMethod.POST, "/auth/external-register").permitAll()
                it.requestMatchers(HttpMethod.GET, "/auth/email-verify").permitAll()
                it.requestMatchers(HttpMethod.POST, "/auth/external-register/resend").permitAll()
                ...
                it.requestMatchers(HttpMethod.GET, "/auth/sso/*/authorize").permitAll()
                it.requestMatchers(HttpMethod.GET, "/auth/sso/*/callback").permitAll()
                it.requestMatchers(HttpMethod.POST, "/auth/sso/token").permitAll()
                it.requestMatchers("/wechat/**").permitAll()
